...
DIFFICULTY_LEVELS_OPTIONS = {'Easy': {'sec_interval_for_autogen': 8,'points_by_difficulty':5, 'board_size': 6 },
'Medium': {'sec_interval_for_autogen': 6,'points_by_difficulty':3, 'board_size': 7 },
'Hard': {'sec_interval_for_autogen': 65, 'points_by_difficulty': 1, 'board_size': 8 }}
...
EMOJIS_CATEGORIES_MEDIUM = ['FOXES', 'EMOJIS', 'HUMANS', 'VEHICLES', 'HOUSES', 'HANDS', 'PURPLE_SIGNS', 'RED_SIGNS', 'BLUE_SIGNS']
EMOJIS_CATEGORIES_HARD = ['FOXES', 'EMOJIS', 'HUMANS', 'FOODS', 'CLOCKS', 'HANDS', 'ANIMALS', 'VEHICLES', 'HOUSES', 'PURPLE_SIGNS', 'RED_SIGNS', 'BLUE_SIGNS', 'MOON']
